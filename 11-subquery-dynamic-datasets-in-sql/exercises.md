# Subquery Dynamic Datasets in SQL Exercises
## Set up
<details>
...
This query gives a consistent average across all of the quantities within the `Purchases` table.

Find the averge of all purchases relative to the user.

## 2.

Use Subqerries to return how many of each individual coruse in `Products` was purchased.
